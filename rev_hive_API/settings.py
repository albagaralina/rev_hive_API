"""
Django settings for rev_hive_API project.
...
SECRET_KEY = 'django-insecure-(*qsovzs_*8r-2s!#ax00h2m*t&r@gy1w&(h0mu88wvw#pjpl8'
...
WSGI_APPLICATION = 'rev_hive_API.wsgi.application'
